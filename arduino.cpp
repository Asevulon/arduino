...
// arduino.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CarduinoApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CarduinoApp

CarduinoApp::CarduinoApp()
{
...
// Единственный объект CarduinoApp

CarduinoApp theApp;


// Инициализация CarduinoApp

BOOL CarduinoApp::InitInstance()
{
